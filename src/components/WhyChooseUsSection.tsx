    ...
    const leftBullets = [
        {
            ...
            description: "Personalized Ayurvedic protocols focused on restoring balance and eliminating toxins from the body.",
        },
        {
            title: "Home-Based Herbal Care",
            description: "Receive herbal remedies and consultations from the comfort of your home with expert guidance.",
        },
        {
            title: "Transparent, Affordable Care",
            description: "Natural therapies that prioritize wellness—without overwhelming financial burden.",
        },
    ]
    ...
    const rightBullets = [
        {
            ...
            description: "Traditional Ayurvedic therapies in serene, healing environments designed for modern comfort.",
        },
        {
            title: "Focused Healing, Measurable Progress",
            description: "Time-tested remedies with clear protocols aimed at restoring vitality and strengthening immunity.",
        },
        {
            title: "Compassion-Focused Healing",
            description: "Empathetic caregivers and supportive wellness staff that nurture body, mind, and spirit.",
        },
    ]

    const BulletItem = ({ title, description }: { title: string; description: string }) => (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)_minmax(0,1.1fr)] gap-10 lg:items-center">
                    ...
                    <div className="space-y-8 order-3 lg:order-1">
                        {leftBullets.map((item, index) => (
                            <BulletItem key={index} title={item.title} description={item.description} />
                        ))}
                    </div>
                ...
                >
                    <div>
                        ...
                        <p className="text-[#4B5563] text-base md:text-lg leading-relaxed">
                            Ayurveda, the science of life, offers natural and effective cancer care. Our Ayurvedic doctors use centuries-old wisdom and personalized herbal treatments to support healing, reduce side effects, and enhance quality of life for patients at every stage.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                        ...
                        <div className="flex-1 space-y-8">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-[#1F2933] mb-1">Cancer Treatment</h3>
                                    <p className="text-[#4B5563] text-sm leading-relaxed">
                                        We provide natural, personalized care using Ayurvedic herbs, detox, diet, and lifestyle adjustments.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-[#1F2933] mb-1">Easy Booking</h3>
                                    <p className="text-[#4B5563] text-sm leading-relaxed">
                        ...
                        <div className="shrink-0 w-full md:w-auto">
                            <div className="rounded-2xl p-6 bg-[linear-gradient(184.51deg,#17899B_4.02%,#109C8E_96.72%)] text-white min-w-[180px] shadow-lg">
                                <div className="w-12 h-12 flex mb-2">
                                    <Image src="/images/DoctorIcon.svg" alt="Doctor" width={39} height={39} />
                                </div>
                                <div className="text-4xl font-semibold mb-5">25+</div>
                                <div className="text-sm font-medium opacity-90 leading-tight">Certified Ayurvedic<br />Experts</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="pt-2">
                        ...
                        >
                            <div className="w-5 h-5 relative">
                                <Image src="/images/CalenderIcon.svg" alt="Calendar" fill className="object-contain" />
                            </div>
                            Book Appointment
